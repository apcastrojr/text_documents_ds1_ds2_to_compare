class TreinamentoAvaliacao:
  ...
  def kmeans(self, dataset_array, label_array, data_teste):
  ...
  if __name__ == '__main__':
    if len(sys.argv) != 4:
       ...
       print("Correto:")
       print("        python3 <nome_arquivo_dataset> <nome_arquivo_teste> <nome_metodo_predicao [mlp, svm, rf, gbc, abc, gpc, tree, nb, bnb, knn, kmeans]>")
    else:
       #constantes
       ...
       elif metodo_predicao == "kmeans":
          resultado_predicao = ta.kmeans(dataset_array,label_array,data_teste)
       ...
       if resultado_predicao == []:
         print("***************************************")
         print("  Erro:")
         print("       Nome método de predição errado. Passar o tipo correto: [mlp, svm, rf, gbc, abc, gpc, tree, nb, knn, kmeans]")
         print("***************************************")
       else:
         acuracia = ta.avaliar_acuracia(resultado_predicao,label_teste)
         print("***************************************")
         print("Accuracy: {}".format(round(acuracia,4)))
